 ...
 */
public class MadisonarMenuActivity extends Activity {

    private MadisonarService.CompassBinder mCompassService;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (service instanceof MadisonarService.CompassBinder) {
                mCompassService = (MadisonarService.CompassBinder) service;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(this, MadisonarService.class), mConnection, 0);
    }
    ...
    private void performActionsIfConnected() {
        if (mCompassService != null) {
            ...
            if (mDoStop){
                mDoStop = false;
                stopService(new Intent(MadisonarMenuActivity.this, MadisonarService.class));
            }
            if (mDoFinish) {
